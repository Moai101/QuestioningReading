...
import static com.moai101.MainActivity.user_nav_image;
...
public class UserImageActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.moai101.R.layout.activity_user_image);
        imageView=(ImageView)findViewById(com.moai101.R.id.add_user_image);
...
//            もし写真がすでにセットされていたら
        if (c.getCount()!=0) {
            ...
            imageView.setImageResource(com.moai101.R.mipmap.person_image);
             }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.moai101.R.menu.image_menu,menu);
        return true;
    }
    @Override
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (!has_set_image) {
            MenuItem menuItem = menu.findItem(com.moai101.R.id.delte_image);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case com.moai101.R.id.image_edit:
                if(!has_set_image){
                    addImage();
                }
                else {
                ...
                return true;
            case com.moai101.R.id.save_image:
                saveImage();
                finish();
                return true;
            case com.moai101.R.id.delte_image:
                deleteImage();
                finish();
                return true;
    ...
    private void deleteImage() {
        ...
        insert_uri=null;
        MainActivity.user_nav_image.setImageResource(com.moai101.R.mipmap.person_image);
        has_set_image=false;
    }
