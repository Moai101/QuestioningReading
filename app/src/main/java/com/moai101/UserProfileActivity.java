...
public class UserProfileActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.moai101.R.layout.activity_user_profile);
        setTitle("My Profile");

        user_name=(EditText)findViewById(com.moai101.R.id.user_name_edit_text_view);
        user_email=(EditText)findViewById(com.moai101.R.id.user_email_edit_text_view);
        user_note =(EditText)findViewById(com.moai101.R.id.user_notes_edit_text_view);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.moai101.R.id.action_delete) {
            showDeleteConfirmationDialog();
            return true;
        }

        else if (id == com.moai101.R.id.action_save){
                save();
            finish();
            return true;
        }
